...
def registration_request(request):
    context={'Link1': 'Home','url1': 'onlinecourse:index',}
...
class CourseListView(generic.ListView):
    ...
    extra_context = {'Link1': 'Online Courses', 'url1': 'onlinecourse:index', }
...
class CourseDetailView(generic.DetailView):
    model = Course
    extra_context = {'Link1': 'Home', 'url1': 'onlinecourse:index', }
...
def submit(request, course_id):
    ...
    print('Enrollment ID:', enrollment.id, 'User:',
          enrollment.user_id, 'mode:', enrollment.mode)
    ...
    for selected_choice in selected_choices:
        ...
        answer = Answer.objects.create(
            submission=submission, choice=choice)  # it must be an instance
...
def show_exam_result(request, course_id, submission_id):
    ...
    print('Course:', course.id, ' Questions:', questions.count(),
          ' Submission:', submission.id, ' Answers:', answs_subm.count())
    ...
    for question in questions:
        ...
        for answ_subm in answs_subm:
            ...
            print(' SelectedChoice ID:', answ_subm.choice_id,
                  'From question:', choi.question_id)
        ...
        print('Question:', question.id, 'Answers',
              ans4check, ' Is correct?', is_corr)
    ...
    context = {'course': course,  'grade': total_score,
               'base': base_score, 'q_corr': q_corr, 'sel_choi': sel_choi, 'Link1': 'Home',
               'url1': 'onlinecourse:index', }
